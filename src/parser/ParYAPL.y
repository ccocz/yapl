...
Stmt
  ...
  | 'local' Ident '=' Expr ';' { (uncurry AbsYAPL.BNFC'Position (tokenLineCol $1), AbsYAPL.LocAss (uncurry AbsYAPL.BNFC'Position (tokenLineCol $1)) (snd $2) (snd $4)) }
  ...
  | 'break' ';' { (uncurry AbsYAPL.BNFC'Position (tokenLineCol $1), AbsYAPL.Break (uncurry AbsYAPL.BNFC'Position (tokenLineCol $1))) }
  | 'continue' ';' { (uncurry AbsYAPL.BNFC'Position (tokenLineCol $1), AbsYAPL.Continue (uncurry AbsYAPL.BNFC'Position (tokenLineCol $1))) }
  ...
  | 'lam' Ident '(' ListArg '):' Block { (uncurry AbsYAPL.BNFC'Position (tokenLineCol $1), AbsYAPL.FnDefArg (uncurry AbsYAPL.BNFC'Position (tokenLineCol $1)) (snd $2) (snd $4) (snd $6)) }
