...
-- | Pretty-printer for PrintYAPL.

module PrintYAPL where
...
instance Print (AbsYAPL.TopDef' a) where
  prt i = \case
    ...
    AbsYAPL.Glob _ items -> prPrec i 0 (concatD [prt 0 items])
...
instance Print (AbsYAPL.Stmt' a) where
  prt i = \case
    ...
    AbsYAPL.Break _ -> prPrec i 0 (concatD [doc (showString "break"), doc (showString ";")])
    AbsYAPL.Continue _ -> prPrec i 0 (concatD [doc (showString "continue"), doc (showString ";")])
    AbsYAPL.Cond _ expr stmt -> prPrec i 0 (concatD [doc (showString "if"), doc (showString "("), prt 0 expr, doc (showString "):"), prt 0 stmt])
    AbsYAPL.CondElse _ expr stmt1 stmt2 -> prPrec i 0 (concatD [doc (showString "if"), doc (showString "("), prt 0 expr, doc (showString "):"), prt 0 stmt1, doc (showString "else"), doc (showString ":"), prt 0 stmt2])
    ...
    AbsYAPL.FnDefArg _ id_ args block -> prPrec i 0 (concatD [doc (showString "lam"), prt 0 id_, doc (showString "("), prt 0 args, doc (showString "):"), prt 0 block])
