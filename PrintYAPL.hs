...
instance Print AbsYAPL.TopDef where
  prt i = \case
    AbsYAPL.FnDef id_ block -> prPrec i 0 (concatD [prt 0 id_, doc (showString ":"), prt 0 block])
...
instance Print AbsYAPL.Block where
  prt i = \case
    AbsYAPL.Block stmts -> prPrec i 0 (concatD [prt 0 stmts])
...
instance Print AbsYAPL.Stmt where
  prt i = \case
    ...
    AbsYAPL.ConstFor id_ expr1 expr2 stmt -> prPrec i 0 (concatD [doc (showString "for"), doc (showString "("), prt 0 id_, doc (showString "="), prt 0 expr1, doc (showString "to"), prt 0 expr2, doc (showString "):"), prt 0 stmt])
    AbsYAPL.SExp expr -> prPrec i 0 (concatD [prt 0 expr, doc (showString ";")])

instance Print AbsYAPL.Item where
  prt i = \case
    AbsYAPL.Init id_ expr -> prPrec i 0 (concatD [prt 0 id_, doc (showString "="), prt 0 expr])
